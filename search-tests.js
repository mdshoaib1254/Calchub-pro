...
if(cards.length!==18){console.log('CORPUS ERROR',cards.length);process.exit(1);}
...
console.log((all.length===18?'PASS':'FAIL')+`  empty query → ${all.length}, expected 18`);
all.length===18?pass++:fail++;
